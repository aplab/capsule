...
var styleStr=NN4?'':'style=" border:1px solid #e0dfe3"';
var imgPlusStr=' src="plus.gif" onmouseup="stopTime()" width="13" height="9" onmouseover="this.style.borderColor=\'#e68b2c\'" onmouseout="stopTime();this.style.borderColor=\'#e0dfe3\'" '+styleStr;
var imgMinusStr=' src="minus.gif" onmouseup="stopTime()" width="13" height="9" onmouseover="this.style.borderColor=\'#e68b2c\'" onmouseout="stopTime();this.style.borderColor=\'#e0dfe3\'" '+styleStr;

gsBottom=('<table align="center" border="0" cellpadding="0" cellspacing="0" width="1"><tr><td><input type="text" name="hourF" size="2" maxlength="2" class="TimeBox" onchange="updateTimeStr()" onfocus="this.value=\'\'"></td><td><img onmousedown="incHour();" '+imgPlusStr+'><br><img onmousedown="decHour();" '+imgMinusStr+'></td><td nowrap>'+_hour_marker+'&nbsp;</td><td><input type="text" name="minF" size="2" maxlength="2" class="TimeBox" onchange="updateTimeStr()" onfocus="this.value=\'\'"></td><td><img onmousedown="incMin();" '+imgPlusStr+'><br><img onmousedown="decMin();" '+imgMinusStr+'></td><td nowrap>'+_hour_marker+'&nbsp;</td><td><input type="text" name="secF" size="2" maxlength="2" class="TimeBox" onchange="updateTimeStr()" onfocus="this.value=\'\'"></td><td><img onmousedown="incSec();" '+imgPlusStr+'><br><img onmousedown="decSec();" '+imgMinusStr+'></td>'+(_is24H?'':'<td>'+_time_marker+'&nbsp;</td><td><input type="Text" name="ampm" size="2" maxlength="2" class="TimeBox" readonly onfocus="flipAmPm();this.blur()"></td>')+'<td valign="middle"><input type="button" value="Ok" onclick="fHideCal();return false;" /></td></tr></table>');
...
function updateTimeStr() {
	var bf=document.cxpBottomForm
	var hv=parseInt(bf.hourF.value,10), mv=parseInt(bf.minF.value,10), sv=parseInt(bf.secF.value,10);
	...
	bf.secF.value=sv>=0&&sv<=59?padZero(Math.floor(sv/_inc)*_inc):"00";
